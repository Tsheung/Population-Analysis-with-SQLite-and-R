---
title: "Population Analysis with SQLite and R"
author: Toby Sheung
date: June 9, 2019
output: md_document
---
...
```{sql, connection = connect, output.var = "mydataframe"}
...
```{sql, connection = connect, output.var = "plot3"}
...
```{sql, connection = connect, output.var = "plot5"}
...
```{sql, connection = connect, output.var = "plot6"}
...
```{sql, connection = connect, output.var = "plot2"}
...
```{sql, connection = connect, output.var = "plot4"}
...
```{sql, connection= connect, output.var = "plot7"}
SELECT name, population, birth_rate, death_rate, population_growth from facts WHERE Name IS NOT 'World' AND population != 0 AND birth_rate != 'NA' AND death_Rate != 'NA' AND population_growth != 'NA'ORDER BY population LIMIT 5
```
